...
#### Figure 2-1. Available Tables, Compared to all CDM Tables
This figure shows which of the CDM tables was received (and not received). 
![dqec_workflow](illustration/fig2-1.png)


#### Figure 2-2. File Size and Row Numbers by Table in the Load
![dqec_workflow](illustration/fig2-2.png)


#### Figure 2-3. Loaded tables against CDM Relational Model.
...
![dqec_workflow](illustration/netwizfig2.gif)
